...
- [MongoLoglessDynamicRaft](MongoLoglessDynamicRaft.tla): protocol for managing the configuration state of the replica set in a separate, logless replicated state machine. 
